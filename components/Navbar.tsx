  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-glassEdge bg-[#05060f]/80 backdrop-blur-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        {/* Brand Logo: Wordmark in font-display with circle icon */}
        ...
        {/* Center Navigation Links: Pill-wash items */}
        ...
        {/* Right Actions: Reset and 6px Void Violet CTA */}
        <div className="flex items-center space-x-2 sm:space-x-3">
          {/* Pill ghost action: Reset */}
          <button
          ...
          {/* Primary High-Stakes CTA: Void Violet with 6px radius (AuthKit signature rule breaker!) */}
          <Link
            href="/dashboard"
